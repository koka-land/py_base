...
proc_time = [0]*(len(proc)+1) #Список потраченного времени на выплднение каждого процесса, +1 для того, чтобы номер элемента списка соответствовал номеру процесса
